  ...
  <footer id="footer">
    ...
    <n-flex :size="4" class="text" align="center" vertical>
      ...
      <n-p depth="3">
        ...
        <n-text depth="3" @click="jumpLink(linkData.home)"> WXIAOW </n-text>
        <n-text
          v-if="siteIcp"
          depth="3"
...
const linkData = {
  github: "https://github.com/asdfghkl12345",
  home: "https://www.wxiaow.us.kg",
  email: "mailto:wangsishun201212@outlook.com",
};
</script>
